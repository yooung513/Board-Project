			...
			<form id="boardFrm">
				...
				<table>
					<tr>
						...
						<td class="tTitle">
							<input type="text" class="tInner" id="title" name="title" placeholder="제목을 입력하세요. (100자 이내)" maxlength="100" value="${board.title }" autofocus>
						</td>
					</tr>
					<tr>
						<th class="tWriter"> 작 성 자 </th>
						<td class="tWriter">
							<input type="text" class="tInner" value="${board.writer }" readonly> 
						</td>
					</tr>
					<tr>
						<th class="tContent"> 내 용 </th>
						<td class="tContent">
							<textarea class="tInner" id="content" name="content" placeholder="내용을 입력하세요. (5000자 이내)" maxlength="5000">${board.content }</textarea>
						</td>
					</tr>
				</table>
